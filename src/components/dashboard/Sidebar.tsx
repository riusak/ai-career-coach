...
{/* Footer Section: Pro Upgrade Banner + Profile */}
      <div className="p-3.5 space-y-2.5 border-t border-slate-800/80 bg-[#071120]">
        ...
        >
          ...
          {/* Payments are not integrated yet — the CTA stays visible but is
              intentionally inert (no redirect to Settings). */}
          <button
            id="upgrade-now-btn"
            type="button"
            disabled
            ...
            className="w-full flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl bg-[#FF7A00] text-white font-bold text-xs shadow-xs mt-2.5 cursor-not-allowed opacity-80"
          >
