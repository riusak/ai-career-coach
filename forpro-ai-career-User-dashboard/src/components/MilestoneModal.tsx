...
import { X, Building, Calendar, CheckCircle2, Flag, Sparkles, Layers } from 'lucide-react';
        ...
        <div className="p-3 rounded-xl bg-amber-50/70 border border-amber-200/80 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs font-bold text-slate-900">
              {isFrench
                ? "ForPro AI : Alignement 92% avec les attentes Lead Architect"
                : "ForPro AI: 92% alignment with Lead Architect requirements"}
            </span>
          </div>
          <button
            onClick={onClose}
